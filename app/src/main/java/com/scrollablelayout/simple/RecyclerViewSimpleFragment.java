...
public class RecyclerViewSimpleFragment extends BaseFragment {
    ...
    public void refreshComplete() {
        if (getActivity() instanceof UserInfoActivity) {
            ((UserInfoActivity) getActivity()).refreshComplete();
        }
    }
    ...
    public class RecyclerAdapter extends RecyclerLoadMoreAdapater<RecyclerBean> {
        ...
        public void onBindViewHolderSuper(RecyclerView.ViewHolder viewHolder, int position) {
            ...
            holder.tvTitle.setText(mDataList.get(viewHolder.getLayoutPosition()).getTitle());
            holder.ivIcon.setBackgroundResource(mDataList.get(viewHolder.getLayoutPosition()).getIcon());
        }
